...
\begin{cventries}
	...
	{\begin{cvitems}
		...
		\item {Project Engineer leading individuals across multiple disciplines (e.g. SW, ME, ID)}
...
\begin{cventries}
	...
	{\def\arraystretch{1.15}{\begin{tabular}{ l l }
		...
		Lab Equipment:  & {\skill{ Oscilloscopes, DMM, VNA, power supplies, multimeters, Raspberry Pi, Arduino}} \\
		Engineering:  & {\skill{ Schematic design, PCB layout, Mentor Graphics, CADSTAR, OrCad, SPICE, Solidworks}} \\
