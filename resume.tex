...
\cvsection{Summary}
\vspace{-2mm}
\summarystyle{Senior Electrical Engineer with 13+ years designing consumer electronic systems from concept through mass production. Experienced in system architecture, schematic design, PCB layout, and cross-functional hardware leadership across networking, display, gaming, and automotive platforms. Proven track record managing contract manufacturer and ODM partnerships, mentoring engineers, and driving technical trade-offs across cost, schedule, and performance. Early adopter of AI-assisted engineering workflows including agentic tooling, MCP server design, and LLM integration for technical documentation and automation.}
...
\begin{cventries}
	...
	{\def\arraystretch{1.5}{\begin{tabular}{ l l}
		Protocols & {\skill{ Ethernet, USB, WiFi, BT, DDR, I2C, SPI, HDMI, MIPI, UART, PCIe, CAN, JTAG, GPS}} \\
		HW Design & {\skill{ Cadence, Allegro, OrCad, Mentor Graphics, CADSTAR, SPICE, Schematic capture, PCB layout, Solidworks}} \\
		 & {\skill{ Signal Integrity, Power Integrity, EMI/EMC, Thermal Management, DFM/DFT}} \\
		Programming & {\skill{ Python, PowerShell, MATLAB, Arduino, Git, TestStand, ADB, VISA}} \\
