	...
	\cventry
	  ...
	  {June 2025 – Present}
	  {
	    \begin{cvitems}
	      ...
	      \item {Directed NPI engagement with a newly onboarded contract manufacturer, shaping the engagement model, build-readiness \hfill \breakexpectations, and cross-team technical workflows}
	    \end{cvitems}
	  }
	\cventry
