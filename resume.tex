...
\cvsection{Summary}
\vspace{-2mm}
\summarystyle{Senior Hardware Engineer with 10+ years of experience in consumer electronics industries working in all phases of the product development life cycle. 
...
\begin{cventries}
	...
	{Jan 2022 – Present}
	{\begin{cvitems}
 		\item {Led and managed high volume product design decision}
		\item {Motherboard PCBA lead driving sound techinical solutions through large cross-disciplinary teams including Power/Thermal, \\ 
  			Power Delivery, Silicon, RF, Wireless, HSIO, LSIO, Desense, AV, ME, SW/FW, DFM, Memory, Storage, and HW test}
...
\begin{cventries}
	...
	{\def\arraystretch{1.5}{\begin{tabular}{ l l}
		...
		Lab Equipment  & {\skill{ Oscilloscopes, multimeters, spectrum analyzers, network analyzers, logic analyzers, power supplies, Raspberry Pi, Arduino, PXI, DAQ}} \\
