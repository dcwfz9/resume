...
\cvsection{Summary}
\vspace{-2mm}
\summarystyle{Senior Electrical Engineer with over 13 years of experience in the electronics industry working in all phases of the product development life cycle. 
Possesses a Master's degree in Electrical Engineering and a broad set of skills and experiences ranging from early prototyping to PCB design to system architecture to validation and mass production.
Highly self-motivated and solution-oriented team player with a growth mindset and passion for technical problem solving and process improvements.}
