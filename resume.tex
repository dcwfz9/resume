...
\cvsection{Summary}
\vspace{-2mm}
\summarystyle{Senior hardware design engineer with 13+ years shipping consumer electronics across networking, display, gaming, and automotive platforms. Owns electrical architecture from schematic and PCB layout through bring-up and validation, integrating wireless, power, audio, camera, and sensor subsystems into compact product designs. Drives component selection and trade-offs across power, cost, performance, and schedule, and partners with ODMs and contract manufacturers from concept to mass production.}
...
\begin{cventries}
	\cventry
	  {Senior Hardware Design Engineer, Devices}
	  {HP IQ, AI Innovation Lab}
	  {San Francisco, CA}
	  {June 2026 – Present}
	  {
	    \begin{cvitems}
	      \item {Driving schematic design, PCB layout, bring-up, and validation for new device hardware}
	      \item {Collaborating across hardware, firmware, mechanical, and security teams to take new devices from concept to production}
	    \end{cvitems}
	  }
	\cventry
