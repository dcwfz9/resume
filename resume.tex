...
\cvsection{Summary}
\vspace{-2mm}
\summarystyle{Systems engineering leader with 13+ years shipping hardware across networking, display, gaming, automotive, and defense platforms. Defines product architecture, drives cross-functional trade-offs across cost, thermal, performance, and schedule, and owns the technical direction from concept through mass production. Leads NPI engagements with contract manufacturers and mentors engineering teams through complex system-level decisions. Builds AI-assisted engineering workflows using agentic tooling and MCP to accelerate hardware design review and validation.}
...
\begin{cventries}
	\cventry
	  ...
	  {
	    \begin{cvitems}
	      \item {Led system-level architecture and electrical design for multi-SKU wired networking platforms, defining platform tenets \hfill \break across performance, integration, and scalability}
	      \item {Partnered with product teams and cross-functional engineering groups to shape system requirements, evaluate architecture \hfill \break options, and drive high-impact trade-off decisions across cost, schedule, and performance}
	      \item {Directed NPI engagement with a newly onboarded contract manufacturer, shaping the engagement model, build-readiness \hfill \break expectations, and cross-team technical workflows}
	      \item {Provided technical leadership across multiple concurrent wired networking programs, leading design reviews and \hfill \break mentoring engineers through complex system-level trade-offs and bring-up}
	    \end{cvitems}
	  }
	\cventry
...
\begin{cventries}
	...
	{\def\arraystretch{1.5}{\begin{tabular}{ l l}
		Protocols & {\skill{ Ethernet (2.5G/10G), PoE (802.3af/at/bt), USB, DDR, I2C, SPI, MDIO, PCIe, HDMI, MIPI, UART, JTAG, CAN, SFP/SFP28, GPS}} \\
		HW Design & {\skill{ Cadence Allegro, OrCAD, Mentor Graphics, CADSTAR, SPICE, Schematic capture, PCB layout, Solidworks}} \\
		 & {\skill{ Signal Integrity, Power Integrity, EMI/EMC, Thermal Architecture, DFM/DFT, Surge/ESD/HiPOT, PoE System Design, Grounding/Isolation}} \\
		Programming & {\skill{ Python, PowerShell, MATLAB, Git, TestStand, VISA, AI-assisted engineering, Agentic tooling, MCP}} \\
		...
		Platforms & {\skill{ Jira, Confluence, Arena PLM, Git, Linux, Google Workspace, Atlassian suite, Azure DevOps}} \\
		\end{tabular}}}
	{}
	{}
	{}
